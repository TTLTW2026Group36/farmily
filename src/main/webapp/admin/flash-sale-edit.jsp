    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <head>
                ...
                <title>Sửa Flash Sale - Admin Farmily</title>
                    ...
                    <main class="admin-main">
                        ...
                        <div class="admin-content">
                            ...
                            <div class="content-header">
                                <div>
                                    <h1 class="content-title">Sửa Flash Sale</h1>
                            ...
                            <form class="admin-form" action="${pageContext.request.contextPath}/admin/flash-sales/edit"
                                method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="productId" name="productId" class="form-control" required>
                                            <c:forEach var="product" items="${products}">
                                                <option value="${product.id}" ${flashSale.productId==product.id
                                                    ? 'selected' : '' }>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="discountPercent" name="discountPercent"
                                                class="form-control" value="${flashSale.discountPercent}" min="1"
                                                max="99" required step="0.1">
                                        </div>
                                        <div class="form-group">
                                            <label for="stockLimit">Giới hạn số lượng bán <span
                                                    class="required">*</span></label>
                                            <input type="number" id="stockLimit" name="stockLimit" class="form-control"
                                                value="${flashSale.stockLimit}" min="1" required>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" id="startTime" name="startTime"
                                                class="form-control"
                                                value="<fmt:formatDate value='${flashSale.startTime}' pattern='yyyy-MM-dd' />T<fmt:formatDate value='${flashSale.startTime}' pattern='HH:mm' />"
                                                required>
                                        </div>
                                        <div class="form-group">
                                            <label for="endTime">Thời gian kết thúc <span
                                                    class="required">*</span></label>
                                ...
                                <div
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Cập nhật Flash Sale
                                    </button>
                                </div>
                            </form>
                        </div>

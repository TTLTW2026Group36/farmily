...
<div class="profile-container">
    <div class="profile-menu">
        ...
        <p>Xin chào, <span id="user-name-sidebar"
                           class="highlight-name">${sessionScope.auth.name}</span>!</p>
        <ul>
            ...
            <form class="info-content edit-mode" id="profile-edit-mode" style="display: none;">
                ...
                <div class="edit-actions">
                    <button type="button" class="btn-cancel-edit"
                            onclick="cancelEditMode()">Hủy</button>
            ...
            <div class="wishlist-section">
                ...
                <div id="wishlist-empty" class="empty-wishlist" style="display: none;">
                    ...
                    <a href="${pageContext.request.contextPath}/san-pham"
                       class="btn-explore">Khám phá sản phẩm</a>
                </div>
            </div>
        </c:if>
    </div>
...
<div id="address-modal" class="modal">
    <div class="modal-content">
        ...
        <form id="address-form" class="address-form">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="receiver">Họ và tên người nhận <span
                            class="required">*</span></label>
                    <input type="text" id="receiver" name="receiver" placeholder="Nhập họ tên"
                           required>
                </div>
                <div class="form-group">

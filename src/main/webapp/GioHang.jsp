        ...
        <%@ taglib prefix="fmt" uri="jakarta.tags.fmt" %>
            ...
            <body>
                ...
                <main class="GioHang_container">
                    <h1 class="page-title">Giỏ hàng <c:if test="${not empty cart.items}"><span id="cartTitleCount"
                                style="font-weight: 400; font-size: 18px; color: #6b7280;">(${cart.items.size()} sản
                                phẩm)</span></c:if>
                    </h1>
                            ...
                            <div class="cart">
                                ...
                                <aside class="cart-summary" aria-label="Tóm tắt đơn hàng">
                                    ...
                                    <div class="summary-row"
                                        ...
                                        <span>Tạm tính (<span id="totalItems">${cart.items.size()}</span> sản
                                            phẩm)</span>
